...
**Open source robots.** Organized by platform type — rovers and cars, arms, quadrupeds, bipedals — covering everything from affordable DIY builds like DonkeyCar and Stanford Pupper to more ambitious research platforms.

**Hardware components.** Actuators, sensors, and bionics, useful when you're sourcing parts rather than a whole robot.

**Software infrastructure.** GUIs, SLAM algorithms, middleware, and simulators — including the usual suspects like Gazebo and CARLA alongside less well-known tools.

**Development tools and libraries.** Frameworks and ROS packages worth having in your toolbox.

**Educational resources.** Books, courses, and tutorials for filling in gaps in robotics fundamentals.

**Reference materials.** Datasets, documentaries, and links to related awesome lists.
...
*Repo: [github.com/msadowski/awesome-weekly-robotics](https://github.com/msadowski/awesome-weekly-robotics) · Newsletter: [weeklyrobotics.com](https://weeklyrobotics.com/)*
